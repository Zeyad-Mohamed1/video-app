...
const Video = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const videoRes = await makeRequest.get(`/videos/find/${path}`);
        const channelRes = await makeRequest.get(
  ...
  const handleSub = async () => {
    currentUser.subscribedUsers.includes(channel._id)
      ? await makeRequest.put(`/users/unsub/${channel._id}`)
      : await makeRequest.put(`/users/sub/${channel._id}`);
